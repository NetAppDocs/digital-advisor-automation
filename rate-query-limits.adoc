...
If the GraphQL API takes more than 60 seconds to process an API request, the server terminates the request and you receive a timeout response and a message reporting that the request has timed out, as shown in the following example.
