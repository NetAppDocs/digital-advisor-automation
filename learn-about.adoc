...
The transition will be phased, with a period of overlap between REST APIs and GraphQL APIs. For each deprecated REST API, a deprecation notice will be published in the Digital Advisor API catalog, you need to migrate that specific endpoint to GraphQL within six months. To identify the REST APIs scheduled for deprecation, see link:identify-deprecated-apis.html[Identify deprecated Digital Advisor REST APIs].
