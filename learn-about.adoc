...
GraphQL is an open source query language that allows clients to request exactly the data they need. The link:https://graphql.org[GraphQL^] data query language has the following attributes:
