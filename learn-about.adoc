...
Digital Advisor brings together business and support system data with configuration and AI-derived insights from AutoSupport telemetry. Instead of siloed views or manual downloads, you can gain programmatic visibility across your NetApp data infrastructure, enabling faster action and smarter decisions.
...
* Upgrade recommendations and history:
  ...
  ** Retrieve recommendations on the next upgrade and whether your systems are ready for upgrade.

All of the data listed can be integrated through API-first workflows into your in-house tools and processes to help make managing your NetApp inventory easier.
