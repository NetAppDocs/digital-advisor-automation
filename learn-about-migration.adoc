...
The GraphQL data query language allows client to request exactly the data they need. The link:https://graphql.org[GraphQL^] data query language has the following benefits:
