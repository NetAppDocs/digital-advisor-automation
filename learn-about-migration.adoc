...
In GraphQL, queries operate like GET requests and mutations operate like POST, PATCH, and DELETE requests in REST. The following table shows some differences between REST and GraphQL:
