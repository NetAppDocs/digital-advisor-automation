...
GraphQL uses two types of operations to fetch data. These are called queries and mutations.  

In GraphQL, queries operate like GET requests and mutations operate like POST, PATCH, and DELETE requests in REST. To learn more about queries and mutations, refer to link:queries-mutations.html[Digital Advisor GraphQL API data queries and mutations].