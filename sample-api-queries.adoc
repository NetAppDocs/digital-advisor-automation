...
[.lead]
After you've generated your tokens and learned how to create a GraphQL request, you can use the example queries to retrieve various types of data from the Digital Advisor GraphQL API.
...
Learn how to use the example GraphQL queries for fleet-wide inventory management. 
...
=== Monitor policy variations (PVRs) 

You can use this query to monitor policy variations (PVRs) for your systems along with their expiration dates.
...
=== Track recommendations and history
...
You can use this query to retrieve recommendations on where to upgrade next and readiness for the upgrade across your fleet.
