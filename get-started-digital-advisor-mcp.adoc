...
sidebar: sidebar
keywords: learn, digital advisor, active-iq, api, query, graphql, api, mcp, model, context, protocol, server, configure, client, tools, 
...
----
+
* Replace `MCP_ENDPOINT_URL` with the MCP endpoint URL that was provided when you registered for the link:https://forms.cloud.microsoft/pages/responsepage.aspx?id=oBEJS5uSFUeUS8A3RRZbOsssLxTVCFxHlhF7IayUVZFUN1hGMEtBMjJaTUJPRDlTMlhJVVczNVo5TC4u&route=shorturl[Active IQ MCP and Digital Coach Early Access Program^]. 
