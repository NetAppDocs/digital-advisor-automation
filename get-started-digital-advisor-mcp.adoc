...
sidebar: sidebar
keywords: learn, digital advisor, active-iq, api, query, graphql, mcp, model, context, protocol, server, configure, client, tools
summary: "Configure an MCP client to connect to the Digital Advisor MCP server and use its available tools."
---
