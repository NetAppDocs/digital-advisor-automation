...
* You have an active Digital Advisor personal access token. Refer to link:generate-pat-token.html[Generate your personal access token to use the Digital Advisor APIs].
