...
* You have an active Digital Advisor personal access token. If you don't already have a token, follow the steps to link:generate-pat-token.html[generate your personal access token].
