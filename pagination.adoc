...
After you return a cursor from a query, you can use the cursor to request the next page of results. To do so, you use the after argument and the pageSize.

For example, assuming that the cursor value from the previous example was 20, you can use this query to request the next page of results:
