...
+
NOTE: Activation is automatic and should be approved instantly. After you are authorized to use the Digital Advisor APIs, you can generate tokens to use when making programmatic API calls.
