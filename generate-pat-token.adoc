...
You need to generate a personal access token before you can use the Digital Advisor GraphQL APIs.
...
== Manage and revoke your personal access tokens

The *Personal Access Tokens* tab lists the name, creation date, expiration date, status, and last authenticated date of each token you created. The token value itself is never shown again in this list.
