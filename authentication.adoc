...
For information on choosing the token type, refer to link:decide-token-type.html[Decide whether to use a personal access token or access and refresh tokens].
