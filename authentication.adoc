...
You need to generate tokens before you can use the Digital Advisor GraphQL APIs. The following steps show how to generate a personal access token, if you want to use access and refresh tokens instead, refer to xref:generate-pat-token.adoc[Generate a personal access token].
