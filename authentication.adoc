...
NOTE: You can repeat this process (refreshing and saving the new token) for *90 days* from your original login date. You *must* log in interactively after 90 days and get a new set of tokens.
